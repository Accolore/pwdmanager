...
<body> 
	<div class="container">
		<div class="text-center mb-4 mt-3">
			<img src="<?php echo base_url('assets/images/icon_accolore.png'); ?>" alt="Accolore" width="100px">
		</div>
		<form method="post" action="<?php echo base_url('login/access/'); ?>">
			<div class="form-floating mb-3">
				<input type="text" name="username" class="form-control form-control-lg" placeholder="User"/>
			...
			<div class="d-grid d-block mb-3">
				<button type="submit" class="btn btn-lg btn-outline-primary"><i class="fas fa-sign-in-alt"></i> Accedi</button>
